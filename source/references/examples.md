...
| Field | Value |
|-------|-------|
| Purpose | Provides worked examples and test cases for report formatting |
| Execution Stage | REPORT |
| Loaded By | Report Engine |
| Dependencies | Report Format Schema |
| Outputs | Example reports, test case scenarios, formatting templates |
